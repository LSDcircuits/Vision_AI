...
The python scripts only use the models trained to detect and to get openCV within a frame, where afterwards OpenCV analyzzes the bitmap to give a results based on ratios measured, 
